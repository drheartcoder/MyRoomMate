...
class Signup extends CI_Controller {
    ...
    //$this->load->library('textlocal.class');


    // $tlEmail = "imran@webwingtechnologies.com";
    // $tlPassword = "Webwing@321"; /*Webwing@321*/
    // $textlocal = new Textlocal($tlEmail, $tlPassword);
...
public function test()
{
  ...
  date:6th june 2017*/
    ...
    $tlEmail = "imran@webwingtechnologies.com";
    $tlPassword = "Webwing@321";
    $textlocal = new Textlocal($tlEmail, $tlPassword);
    $_otp = $this->generatePassword(6);    
  ...
  */
  ...
  {
      $password = "";
      $possible = "12346789abcdefghijklmnopqrstuvwxyzABCDFGHJKLMNPQRTVWXYZ";
