  ...
  <div id="main-content">
    ...
    <div id="breadcrumbs">
      <ul class="breadcrumb">
        ...
        <li class="active">Update Attribute </a>
      </ul>
    </div>
    <!-- END Breadcrumb -->
      ...
      <div class="col-md-12">
        <div class="box box-magenta">
            ...
            <div class="box-content">
              <form method="post" class="form-horizontal" id="update-form" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/attribute/update/<?php echo $this->uri->segment(4); ?>">
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-lg-4 controls">
                    <input type="text" class="form-control beginningSpace_restrict CopyPast_restrict" name="attribute_name" id="attribute_name" placeholder="Please Enter Attribute Name"  value="<?php echo $attribute_info[0]['attribute_name']; ?>"/>
                ...
                <div class="form-group">
                  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                    <input type="submit" value="Update" class="btn btn-primary" name="btn_add_attribute" id="btn_add_attribute">
                    <a class="btn" href="<?php echo base_url().ADMIN_PANEL_NAME;?>attribute/manage/" >Cancel </a>
                  </div>
                </div>
              </form>
            </div>
