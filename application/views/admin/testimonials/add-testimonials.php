            ...
            <div class="box">
                ...
                <div class="box-content">
                   <?php
                            ...
                            echo form_open_multipart(base_url()."admin/testimonials/add/",$attr);
                                        ?>
                                ...
                                <div class="form-group" style="margin-right:0 !important; margin-left:0 !important; ">
                                    ...
                                    <div class="col-sm-6 col-lg-4 controls">
                                        <input type="text"
                                               ...
                                               placeholder=" Name"
                                               value="<?php echo set_value ('testimonials_name_en'); ?>"/>
                                ...
                                <div class="form-group" style="margin-right:0 !important; margin-left:0 !important; ">
                                    ...
                                    <div class="col-sm-6 col-lg-4 controls">
                                        <input data-rule-ckvalidation="true"
                                                  ...
                                                  value="<?php echo set_value ('testimonials_added_by'); ?>"/>
                                ...
                                <div class="form-group" style="margin-right:0 !important; margin-left:0 !important; ">
                                    ...
                                    <div class="col-sm-9 controls">
                                        <textarea data-rule-ckvalidation="true"
                                                  ...
                                                  <?php echo set_value ('page_disc_en'); ?>
                                        </textarea>
                                      ...
                                      <div class="form-group" style="margin-right:0 !important; margin-left:0 !important; ">
                                                      ...
                                                      <div class="col-sm-6 col-lg-3 controls">
                                                          <input data-rule-ckvalidation="true"
                                                                    ...
                                                                    data-rule-minlength="10"
                                                                    placeholder=" Date"
                                                                    value="<?php echo set_value ('testimonials_date'); ?>"/>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-6  col-lg-7">
                                    <input type="submit" name="testimonials_add" id="testimonials_add`" class="btn btn-primary" value="Add" onclick="checkValidation()">
                            </div>
                        </div>
                    </div>
                    <?php
