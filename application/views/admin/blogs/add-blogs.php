            ...
            <div class="box">
                ...
                <div class="box-content">
                   <?php
                            ...
                            echo form_open_multipart(base_url()."admin/blogs/add/",$attr);
                                        ?>
                            ...
                            <div id="english" class="tab-pane fade active in">
                                <div class="form-group" style="margin-right:0 !important; margin-left:0 !important; ">
                                    ...
                                    <div class="col-sm-6 col-lg-4 controls">
                                        <input type="text"
                                               ...
                                               placeholder=" Name"
                                               value="<?php echo set_value ('blogs_name_en'); ?>"/>
                                ...
                                <div class="form-group" style="margin-right:0 !important; margin-left:0 !important; ">
                                    ...
                                    <div class="col-sm-6 col-lg-4 controls">
                                        <input data-rule-ckvalidation="true"
                                                  ...
                                                  value="<?php echo set_value ('blogs_added_by'); ?>"/>
                                ...
                                <div class="form-group" style="margin-right:0 !important; margin-left:0 !important; ">
                                             ...
                                             <div>
                                                 ...
                                                 <input type="file" class="file-input" name="sv_logo" id="fileUpload"  data-rule-required='true'/></span>
                                      ...
                                      <div class="form-group" style="margin-right:0 !important; margin-left:0 !important; ">
                                                      ...
                                                      <div class="col-sm-6 col-lg-3 controls">
                                                          <input data-rule-ckvalidation="true"
                                                                    ...
                                                                    data-rule-minlength="10"
                                                                    placeholder=" Date"
                                                                    value="<?php echo set_value ('blogs_date'); ?>"/>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-6  col-lg-7">
                                    <input type="submit" name="blogs_add" id="blogs_add`" class="btn btn-primary" value="Add" onclick="checkValidation()">
                            </div>
                        </div>
                    </div>
                    <?php
