                                ...
                                <div class="title-bar">
                                    <div class="page-title">Blog</div>
                                         <div class="top_breadcrumb"> <a href="<?php echo base_url() ?>">Home </a> &nbsp;<span><i class="fa fa-angle-right"></i>
                                            </span>&nbsp; <a href="javascript:void(0);" class="act">Blog</a>
                                        </div>
         ...
         <div class="col-sm-8 col-md-9 col-lg-9">
            ...
            <div class="blog-main-block">
               ...
               <div class="main-blog-block-img">
                  ...
                  <?php /* <img class="event_pic " src="<?php echo base_url().'timthumb.php?src='.base_url().'uploads/blogs_images/'.$blogs_row['blogs_img'].'&h=350&w=870&zc=0'; ?>" alt="" data-description=""> */ ?>
