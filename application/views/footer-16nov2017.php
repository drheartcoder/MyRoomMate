         ...
         <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="footer-block">
               ...
               <ul>
                  ...
                  <li class="vimeo"><a href="<?php echo $social[0]['instagram_link']; ?>">&nbsp;</a></li>
                  <li class="linkedin"><a href="<?php echo $social[0]['linkedin_link']; ?>">&nbsp;</a></li>
                  <li class="rss"><a href="<?php echo $social[0]['pinterest_link']; ?>">&nbsp;</a></li>
               </ul>
            </div>
         </div>
         <div class="col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="login-modal">
               <div class="login-form">
                  ...
                  <form id="registerForm" name="registerForm" method="POST" novalidate>
                     ...
                     <div class="form-group input-box-w" ng-class="{ 'has-error': loginForm.mobile.$touched && loginForm.mobile.$invalid }">
                        <input type="text" class="input-box check_mobile space_restrict beginningSpace_restrict" id="registermobile" name="registermobile" ng-model="user.mobile" ng-minlength="5" ng-maxlength="20" required/>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <div id="err_register_mobile" class="error"></div>
                        <div ng-messages="loginForm.mobile.$error" ng-if="loginForm.$submitted || loginForm.mobile.$touched">
                           <div ng-messages-include="error-message.html"></div>
                        </div>
                        <label>Mobile</label>
                     </div>
