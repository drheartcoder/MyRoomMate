  ...
  <div class="row">
   <div class="col-md-12">
    <div class="box box-magenta">
     ...
     <form name="frm-manage" id="frm-manage" method="post" action="<?php echo base_url().ADMIN_PANEL_NAME.'pricing/manage';?>">
         ...
         <div class="col-md-10">
           ...
           if($this->session->flashdata('error')!=''){  ?>
             ...
             <div class="btn-toolbar pull-right clearfix">
               ...
               <div class="btn-group"> <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" title="Refresh" href="<?php echo base_url().ADMIN_PANEL_NAME.'pricing/manage'; ?>"style="text-decoration:none;"><i class="fa fa-repeat"></i></a> </div>
             </div>
             <br/><br/>
                 ...
                 foreach($fetchdata as $row)
                 {
                   ...
                   <tr>
                    ...
                    <?php if($row['membership_price']!='free'){ ?>  
                     <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" title="Update" style="text-decoration:none;" data-original-title="Edit" href="<?php echo base_url().ADMIN_PANEL_NAME.'pricing/update/'.$row['membership_id'].''; ?>">
