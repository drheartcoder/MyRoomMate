            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="listing-detail-right">
                    ...
                    <div class="rating-detailpage">
                        <ul class="ratings-ul">
                            <li><div class="starbox colours ghosting small autoupdate" data-button-count="10" data-star-count="5"></div><span class="rivew-count" ><?php if($all_rating!='0'){ echo $all_rating; } else { echo '0'; } ?></span></li>
                            <li>Good</li>
                   ...
                   <h3>Listing Details</h3>
                    ...
                    <table class="table transe-detai-table my-profile-table listndetailstb">                                
                        <tbody>
                          ...
                          <tr>
                            <td class="bold-fnts">Created On</td>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="button-innerpage">
                            ...
                            <?php if( $this->session->userdata('user_id') == "" ) { ?>
                            <a data-toggle="modal" href="#login">REPORT AS SCAM</a>
                            <?php } else { ?>
                            <!-- <a data-toggle="modal" href="#reportasscam" >REPORT AS SCAM</a> -->
                            <a href="javascript:void(0)" id="reportscam" name="reportscam">REPORT AS SCAM</a>

                            <form id="inquiryForm" name="inquiryForm" method="POST" novalidate>
                            <div id="reportscam_success" class="success"></div>
                            <div id="reportscam_error" class="error"></div>
                            <input type="hidden" name="reportscam_name" id="reportscam_name" value="<?php echo $this->session->userdata['user_firstname']; ?>">  
                            <input type="hidden" name="reportscam_lname" id="reportscam_lname" value="<?php echo $this->session->userdata['user_lastname']; ?>">  
                            <input type="hidden" name="reportscam_email" id="reportscam_email" value="<?php echo $this->session->userdata['user_email']; ?>">  
                            <input type="hidden" name="reportscam_title" id="reportscam_title" value="<?php echo $addlisting[0]['title']; ?>">
                            <input type="hidden" name="reportscam_listingid" id="reportscam_listingid" value="<?php echo $addlisting[0]['id']; ?>">
...
<?php /*
<!--Send Scam Report modal start here-->
<div id="reportasscam" class="modal fade popup-cls" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="login-modal">
                    <div class="login-form">
                        <!-- <h1>Contact</h1> -->
                        <h4 style="text-align:center;">This post As A Scam</h4>
                        <div id="reportscam_success" class="success"></div>
                        <div id="reportscam_error" class="error"></div>
                        <form id="inquiryForm" name="inquiryForm" method="POST" novalidate>
                            <input type="hidden" name="reportscam_name" id="reportscam_name" value="<?php echo $this->session->userdata['user_firstname']; ?>">  
                            ...
                            <input type="hidden" name="reportscam_title" id="reportscam_title" value="<?php echo $addlisting[0]['title']; ?>">
                            <input type="hidden" name="reportscam_listingid" id="reportscam_listingid" value="<?php echo $addlisting[0]['id']; ?>">
                            <button id="reportscam" name="reportscam" class="hvr-rectangle-out orng-btn" type="submit">Report as scam</button>
                        </form>
                    </div>
...
<!--Send Scam Report modal end here-->
*/ ?>
