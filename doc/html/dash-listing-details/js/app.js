...
app.config(['$routeProvider', function ($routeProvider) {
    ...
    .when("/blog", { templateUrl: "blog.html", controller: "PageCtrl" })
    .when("/blog-details", { templateUrl: "blog-details.html", controller: "PageCtrl" })
    .when("/contact-us", { templateUrl: "contact-us.html", controller: "PageCtrl" })
    .when("/dashboard-listing-details", { templateUrl: "dashboard-listing-details.html", controller: "PageCtrl" })
