   ...
   if(page_url_segment == 'home'){
    ...
    if(flag == 0) {
      ...
      $.ajax({
        ...
        type:'POST',
        data:{firstname:firstname,lastname:lastname,uemail:uemail,username:username,mobile_number:mobile_number,gender:gender,country:country,password1:password1},
        dataType:'json',
        success:function(response)
        {
